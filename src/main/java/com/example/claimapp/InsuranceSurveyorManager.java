...
public class InsuranceSurveyorManager {
    public void insuranceSurveyorMenu(ArrayList<Claim> claims) {
        ...
        searchButton.setOnAction(e -> {
            ...
            for (Claim claim : claims) {
                if (claim.getId().contains(searchID) && claim.getStatus().equals("Pending")) {
